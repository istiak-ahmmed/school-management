<div>
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">সকল প্রকার ঘোষণা এবং আপডেট</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <select wire:model.live="category" class="rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
            ...
            <div class="relative w-full sm:w-64">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="নোটিশ খুঁজুন..." class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm pl-10">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-0">
            @forelse($notices as $notice)
                <div class="p-6 border-b border-gray-100 last:border-b-0 hover:bg-emerald-50/30 transition {{ $notice->is_pinned ? 'bg-orange-50/10' : '' }}">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
                                @if($notice->is_pinned)
                                    <svg class="w-4 h-4 text-orange-500 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path></svg>
                                @endif
                                {{ $notice->title }}
                            </h3>
                            ...
                            @if($notice->attachment_path)
                                <div class="mt-4">
                                    <a href="{{ Storage::url($notice->attachment_path) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-emerald-200 shadow-sm text-sm font-medium rounded-md text-emerald-700 bg-emerald-50 hover:bg-emerald-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
            ...
            @empty
                <div class="p-16 text-center">
                    ...
                    <p class="text-sm text-gray-500">আপনার খোঁজার সাথে মিল রেখে কোনো নোটিশ পাওয়া যায়নি।</p>
                </div>
            @endforelse
        </div>
