<div>
            ...
            <div class="p-6">
                <form wire:submit.prevent="save">
                    <div class="overflow-x-auto mb-6">
                        ...
                        <th scope="col" class="px-5 py-3 font-semibold rounded-l-lg text-center cursor-pointer hover:bg-gray-100 font-medium text-gray-500 text-xs tracking-wider"  wire:click="sortBy('id')" >
    <div class="flex items-center justify-center space-x-1">
        ...
        @endif
                            ...
                            <td class="px-5 py-4 text-gray-800 text-center">
                                {{ $loop->iteration }}
                            </td>
